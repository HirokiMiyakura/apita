<div class="hamburger sp">
  ...
  <div class="nav-container">
    ...
    <a href="<?php echo home_url(); ?>/shopguide/" class="border-none">ショップガイド</a>
    <div class="four">
    ...
    <a href="<?php echo home_url(); ?>/floorguide/">フロアガイド</a>
    <a href="<?php echo home_url(); ?>/access/">アクセス</a>
    <a href="<?php echo home_url(); ?>/eventnews/">イベント&ニュース</a>
    <a href="<?php echo home_url(); ?>/line/">LINE 公式アカウント</a>
    <a target="_blank" href="https://mydomo.domonet.jp/apita.walk-senmontengai/">求人</a>
    <a href="<?php echo home_url(); ?>/facility/">施設案内</a>
  </div>
</div>