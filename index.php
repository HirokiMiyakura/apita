...
<section id="SLIDER">
  <div class="main-slider">
    <div><img src="<?php echo get_template_directory_uri(); ?>/img/slick/banner1.jpg" alt="お客様へのお知らせバナー" /></div>
    <div><img src="<?php echo get_template_directory_uri(); ?>/img/slick/banner2.jpg" alt="アピタ戸塚店バナー" /></div>
    <div><a href="<?php echo home_url(); ?>/line/"><img src="<?php echo get_template_directory_uri(); ?>/img/slick/banner3.jpg" alt="LINE公式アカウントバナー" /></a></div>
  </div>
</section>
<section id="INFO">
  <div class="inner">
